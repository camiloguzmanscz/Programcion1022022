...
public class App {
    public static void main(String[] args) {
        Repetition Utility =new Repetition();
        ...
        System.out.println("The most Repeated word is " + Arrays.toString(c1));//Should print [this, 7] 

        final String[] c2 = Utility.Repeated("This is a repeated word test this word word word"); 

        System.out.println("The most Repeated word  is " + Arrays.toString(c2));//Should print [word, 4] 
